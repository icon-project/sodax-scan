const getAssets = async () => {
    const assetIds = `icon,binancecoin,ethereum,bitcoin,injective-protocol,avalanche-2,arbitrum,optimism,polygon-ecosystem-token,sui,stellar,solana,sonic-3,hyperliquid,nibiru,lightlink,kaia`
